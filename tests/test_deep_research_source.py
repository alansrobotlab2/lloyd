...
async def test_the_turn_cannot_reach_what_a_fetched_page_would_want(
    ...
    for name in WORKER_SELFMOD_BAN:
...
def test_the_source_yields_to_the_selfmod_workers():
    ...
    from workers.sources import backlog_implement, backlog_selfmod
    assert backlog_implement.DEFAULT_PRIORITY < backlog_selfmod.DEFAULT_PRIORITY
    assert backlog_selfmod.DEFAULT_PRIORITY < D.DEFAULT_PRIORITY
