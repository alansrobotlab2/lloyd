"""An automod round's worktree path must not make every call look like a repeat.
...
automod round opens `cd /home/<user>/lloyd-work/SM_<round>/home/lloyd &&`, and
...
round reached `automod_gate` and `automod_land` ninety seconds later with no
...
from fixture_iv_automod_worktree import WORKTREE_BASH_CALLS  # noqa: E402
