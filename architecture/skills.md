...
relations:
  related-to: []
tags: [architecture]
summary: 'Skill system: on-demand SKILL.md procedures loaded from ~/obsidian/skills/,
  ClawhHub marketplace integration,security validation pipeline,and 34 current custom
  skills.'
type: reference
...
Clean or low-risk warnings + markdown-only + <500 lines 