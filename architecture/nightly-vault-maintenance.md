...
|------------|-----|---------|-------|
| 1:30 AM | `day-end-synthesis` | Extract key decisions,open questions,corrections quality | [SKILL.md](../../skills/day-end-synthesis/SKILL.md) |
...
| 3:00 AM | `nightly-skills-management` | Skills extraction,evaluation,dedup,effectiveness | [SKILL.md](../../skills/nightly-skills-management/SKILL.md) |
...
| 4:40 AM | `reflection-config` | Config improvements,commits,summary | [SKILL.md](../../skills/nightly-reflection-config/SKILL.md) |
| 5:00 AM | `nightly-prompt-audit` | System prompt quality audit & drift detection | [SKILL.md](../../skills/nightly-prompt-audit/SKILL.md) |
| 5:20 AM | `nightly-behavior-test` | Synthetic behavior tests & regression suite | [SKILL.md](../../skills/nightly-behavior-test/SKILL.md) |
| 7:00 AM | `morning-briefing` | Synthesize overnight res