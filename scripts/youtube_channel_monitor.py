...
def newest_retrieval_baseline(baselines_dir=None):
    ...
    `eval/baselines/` holds several kinds of file — nightly runs, automod
    ...
    the one the dashboard and the automod gate quote.
    """
    import glob
    ...
    for path in glob.glob(os.path.join(d, "*.json")):
        try:
            ...
            continue
        # The eval runner writes `summary: {overall, by_category}`; the automod
