#!/usr/bin/env python3
"""
Fact Extraction Runner - Process remaining documents in smaller batches
"""
...
def main():
    ...
    for i in range(0, len(remaining_docs), batch_size):
        ...
        # Progress summary
        print(f"  Progress: {len(processed_docs)}/{total_docs} docs, {total_facts} total facts, {errors} errors")
        print()
