...
`scripts/selfmod/backlog.py` for the triage/implement loop, and the React
...
`lint_findings` does: `scripts/selfmod/backlog.py` is the light module the
selfmod CLI loads, and it must not pull `mcp` and `httpx` in behind a
fifteen-line helper.
"""
