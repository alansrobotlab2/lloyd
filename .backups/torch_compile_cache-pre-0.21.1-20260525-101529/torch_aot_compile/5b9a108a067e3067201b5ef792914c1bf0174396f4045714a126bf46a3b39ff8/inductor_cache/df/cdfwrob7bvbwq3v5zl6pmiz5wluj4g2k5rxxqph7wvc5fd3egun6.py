...
def triton_(in_ptr0, in_ptr1, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r0_offset in tl.range(0, r0_numel, R0_BLOCK):
        ...
        tl.store(out_ptr1 + (r0_1 + 10240*x0), tmp19, r0_mask & xmask)


def get_args():
    arg_0 = rand_strided((8192, 5120), (5120, 1), device='cuda:0', dtype=torch.bfloat16)
    arg_1 = rand_strided((5120,), (1,), device='cuda:0', dtype=torch.bfloat16)
    arg_2 = rand_strided((8192, 5120), (10240, 1), device='cuda:0', dtype=torch.bfloat16)
    return arg_0, arg_1, arg_2, 8192, 5120,
