...
def get_args():
    arg_0 = rand_strided((8192, 32, 256), (8192, 256, 1), device='cuda:0', dtype=torch.bfloat16)
    arg_1 = rand_strided((8192, 8192), (8192, 1), device='cuda:0', dtype=torch.bfloat16)
    arg_2 = rand_strided((8192, 8192), (8192, 1), device='cuda:0', dtype=torch.bfloat16)
