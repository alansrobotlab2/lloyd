...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/2ec44fe223091dd3125aa8d57d617e256c37ec1069f2554f70696031b440e76e/inductor_cache/3h/c3h7ovv4zs4fl2azfkylutvlvmuiqnyoxfkkpeiyipdsogwbe7yq.py
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/2ec44fe223091dd3125aa8d57d617e256c37ec1069f2554f70696031b440e76e/inductor_cache/iu/ciu53e5afjh4b7cnhed2ocrhuy5rstgyjymsep4x7ftn54ljauf2.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/2ec44fe223091dd3125aa8d57d617e256c37ec1069f2554f70696031b440e76e/inductor_cache/6h/c6h5dwf6avmg3gxm6xx3fqj2rb2tuejrm5gb26gvh2xw6flq7g5y.py
...
#   %arg7_1 : Tensor "bf16[5120][1]cuda:0" = PlaceHolder[target=arg7_1]
#   %convert_element_type_5 : Tensor "f32[5120][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg7_1, torch.float32), kwargs = {})
#   %add_19 : Tensor "f32[5120][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_5, 1.0), kwargs = {})
#   %convert_element_type_default_4 : Tensor "f32[s18, 5120][5120, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mm, torch.float32), kwargs = {})
...
#   %mul_tensor_5 : Tensor "f32[s18, 5120][5120, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_tensor_4, %add_19), kwargs = {})
...
def triton_red_fused__to_copy_add_rms_norm_2(in_ptr0, in_ptr1, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r0_offset in tl.range(0, r0_numel, R0_BLOCK):
        ...
        rindex = r0_index
        r0_1 = r0_index
        tmp6 = tl.load(in_ptr0 + (r0_1 + 5120*x0), r0_mask & xmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/2ec44fe223091dd3125aa8d57d617e256c37ec1069f2554f70696031b440e76e/inductor_cache/w2/cw2dhien2serxidkre2u5yzr5wm4fdkxvyamgcu2cvumk2ojg4t7.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/2ec44fe223091dd3125aa8d57d617e256c37ec1069f2554f70696031b440e76e/inductor_cache/r6/cr6p6frawdj637qi4lgs2vjuypzfled2dxsl6sam5nghcxvxmy2w.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
@triton_heuristics.reduction(
    ...
    inductor_meta={'grid_type': 'SequentialComboKernelGrid', 'combo_grid_meta': {'num_kernels': 2, 'min_blocks': None, 'default_config': None, 'no_x_dim_0': False, 'xnumel_0': None, 'no_x_dim_1': False, 'xnumel_1': None}, 'kernel_name': 'triton_red_fused_4', 'mutated_arg_names': [], 'backend_hash': '228E29CD04A1C0E45A497D2BB702521B2A73AF056F742B69E679ABE0C11C5D1C', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': False, 'are_deterministic_algorithms_enabled': False}
)
@triton.jit
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/2ec44fe223091dd3125aa8d57d617e256c37ec1069f2554f70696031b440e76e/inductor_cache/6c/c6cvaorxhbeioyczxfb675grykjebgorb6rj67h5ieijrny3f6pl.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'SequentialComboKernelGrid', 'combo_grid_meta': {'num_kernels': 4, 'min_blocks': None, 'default_config': None, 'no_x_dim_0': False, 'xnumel_0': None, 'no_x_dim_1': False, 'xnumel_1': None, 'no_x_dim_2': False, 'xnumel_2': None, 'no_x_dim_3': False, 'xnumel_3': None}, 'kernel_name': 'triton_poi_fused_5', 'mutated_arg_names': [], 'backend_hash': '228E29CD04A1C0E45A497D2BB702521B2A73AF056F742B69E679ABE0C11C5D1C', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': False, 'are_deterministic_algorithms_enabled': False}
)
@triton.jit
def triton_poi_fused_5(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, out_ptr1, out_ptr2, out_ptr3, xnumel_0, xnumel_1, xnumel_2, xnumel_3, XBLOCK : tl.constexpr):
    ...
    if pid < num_xblocks_0:
        ...
        tmp4 = tmp0 < tmp3
        tmp5 = tl.load(in_ptr0 + (12288 + 256*x1 + 14336*x2 + (x0)), tmp4 & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        ...
        tmp21 = tmp19 * tmp20
        tmp22 = tl.load(in_ptr0 + (12320 + 256*x1 + 14336*x2 + (x0)), tmp4 & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        ...
        tmp37 = tmp0 < tmp36
        tmp38 = tl.load(in_ptr0 + (12320 + 256*x1 + 14336*x2 + ((-32) + x0)), tmp35 & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        ...
        tmp54 = tmp52 * tmp53
        tmp55 = tl.load(in_ptr0 + (12288 + 256*x1 + 14336*x2 + ((-32) + x0)), tmp35 & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        ...
        x6 = xindex // 768
        x7 = xindex // 192
        tmp69 = tl.load(in_ptr0 + (12352 + x4 + 256*x5 + 14336*x6), xmask).to(tl.float32)
        ...
        tmp88 = tmp84 < tmp87
        tmp89 = tl.load(in_ptr0 + (512*x9 + 14336*x10 + (x8)), tmp88 & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        ...
        tmp106 = tl.load(in_ptr0 + (32 + 512*x9 + 14336*x10 + (x8)), tmp88 & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        ...
        tmp121 = tmp84 < tmp120
        tmp122 = tl.load(in_ptr0 + (32 + 512*x9 + 14336*x10 + ((-32) + x8)), tmp119 & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        ...
        tmp139 = tl.load(in_ptr0 + (512*x9 + 14336*x10 + ((-32) + x8)), tmp119 & xmask, eviction_policy='evict_last', other=0.0).to(tl.float32)
        ...
        x14 = xindex // 4608
        x15 = xindex // 192
        tmp153 = tl.load(in_ptr0 + (64 + x12 + 512*x13 + 14336*x14), xmask).to(tl.float32)
...
def get_args():
    arg_0 = rand_strided((8192, 14336), (14336, 1), device='cuda:0', dtype=torch.bfloat16)
    arg_1 = rand_strided((8192, 4, 1), (4, 1, 32768), device='cuda:0', dtype=torch.float32)
    ...
    arg_5 = rand_strided((8192, 24, 1), (24, 1, 196608), device='cuda:0', dtype=torch.float32)
    arg_6 = rand_strided((256,), (1,), device='cuda:0', dtype=torch.bfloat16)
    arg_7 = rand_strided((8192, 4, 64), (1024, 256, 1), device='cuda:0', dtype=torch.bfloat16)
    arg_8 = rand_strided((8192, 4, 192), (1024, 256, 1), device='cuda:0', dtype=torch.bfloat16)
    arg_9 = rand_strided((8192, 24, 64), (6144, 256, 1), device='cuda:0', dtype=torch.bfloat16)
    arg_10 = rand_strided((8192, 24, 192), (6144, 256, 1), device='cuda:0', dtype=torch.bfloat16)
    return arg_0, arg_1, arg_2, arg_3, arg_4, arg_5, arg_6, arg_7, arg_8, arg_9, arg_10, 2097152, 6291456, 12582912, 37748736,
...
with torch.cuda._DeviceGuard(0):
    stream0 = get_raw_stream(0)
stream0 = get_raw_stream(0)
arg13_1 = generate_example_value((3, 8192), (8193, 1), 'cuda:0', torch.int64, 0, (3, 8192))
arg12_1 = generate_example_value((1048576, 64), (64, 1), 'cuda:0', torch.bfloat16, 0, (1048576, 64))
...
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_0.run(arg13_1, arg12_1, buf11, buf12, 8193, 262144, stream=stream0)
del arg13_1, arg12_1
...
arg5_1 = generate_example_value((8192, 5120), (5120, 1), 'cuda:0', torch.bfloat16, 0, (8192, 5120))
arg4_1 = generate_example_value((5120,), (1,), 'cuda:0', torch.bfloat16, 0, (5120,))
buf2 = generate_example_value((8192, 5120), (10240, 1), 'cuda:0', torch.bfloat16, 0, (8192, 5120))
buf3 = generate_example_value((8192, 5120), (10240, 1), 'cuda:0', torch.bfloat16, 0, (8192, 5120))
with torch.cuda._DeviceGuard(0):
    triton_red_fused_1.run(arg0_1, arg2_1, arg3_1, arg5_1, arg4_1, buf2, buf3, 8192, 8192, stream=stream0)
del arg0_1, arg2_1, arg3_1, arg5_1, arg4_1, buf2, buf3

stream0 = get_raw_stream(0)
buf5 = generate_example_value((8192, 5120), (5120, 1), 'cuda:0', torch.bfloat16, 0, (8192, 5120))
arg7_1 = generate_example_value((5120,), (1,), 'cuda:0', torch.bfloat16, 0, (5120,))
buf7 = generate_example_value((8192, 5120), (5120, 1), 'cuda:0', torch.bfloat16, 0, (8192, 5120))
with torch.cuda._DeviceGuard(0):
    triton_red_fused__to_copy_add_rms_norm_2.run(buf5, arg7_1, buf7, 8192, 5120, stream=stream0)
del buf5, arg7_1, buf7

stream0 = get_raw_stream(0)
buf8 = generate_example_value((8192, 14336), (14336, 1), 'cuda:0', torch.bfloat16, 0, (8192, 14336))
buf20 = generate_example_value((8192, 6144), (6144, 1), 'cuda:0', torch.bfloat16, 0, (8192, 6144))
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_3.run(buf8, buf20, 50331648, stream=stream0)
del buf20

stream0 = get_raw_stream(0)
buf9 = generate_example_value((8192, 24, 1), (24, 1, 196608), 'cuda:0', torch.float32, 0, (8192, 24, 1))
buf10 = generate_example_value((8192, 4, 1), (4, 1, 32768), 'cuda:0', torch.float32, 0, (8192, 4, 1))
with torch.cuda._DeviceGuard(0):
    triton_red_fused_4.run(buf8, buf9, buf10, 196608, 32768, stream=stream0)
...
buf13 = generate_example_value((8192, 4, 64), (1024, 256, 1), 'cuda:0', torch.bfloat16, 0, (8192, 4, 64))
buf14 = generate_example_value((8192, 4, 192), (1024, 256, 1), 'cuda:0', torch.bfloat16, 0, (8192, 4, 192))
buf16 = generate_example_value((8192, 24, 64), (6144, 256, 1), 'cuda:0', torch.bfloat16, 0, (8192, 24, 64))
buf17 = generate_example_value((8192, 24, 192), (6144, 256, 1), 'cuda:0', torch.bfloat16, 0, (8192, 24, 192))
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_5.run(buf8, buf10, arg11_1, buf11, buf12, buf9, arg10_1, buf13, buf14, buf16, buf17, 2097152, 6291456, 12582912, 37748736, stream=stream0)
del buf11, buf12, buf8, buf9, buf10, arg11_1, arg10_1, buf13, buf14, buf16, buf17
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            buf4 = empty_strided_cuda((s18, 10240), (10240, 1), torch.bfloat16)
            buf2 = reinterpret_tensor(buf4, (s18, 5120), (10240, 1), 0)  # alias
            buf3 = reinterpret_tensor(buf4, (s18, 5120), (10240, 1), 5120)  # alias
            # Unsorted Source Nodes: [], Original ATen: []
            triton_poi_fused_0_xnumel = 32*s18
            stream0 = get_raw_stream(0)
            triton_poi_fused_0.run(arg13_1, arg12_1, buf11, buf12, s7, triton_poi_fused_0_xnumel, stream=stream0)
            # Unsorted Source Nodes: [], Original ATen: []
            stream0 = get_raw_stream(0)
            triton_red_fused_1.run(arg0_1, arg2_1, arg3_1, arg5_1, arg4_1, buf2, buf3, s18, s18, stream=stream0)
            del arg0_1
            del arg12_1
            del arg13_1
            del arg2_1
            ...
            del buf2
            del buf3
            buf5 = empty_strided_cuda((s18, 5120), (5120, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear], Original ATen: [aten.t, aten.mm]
            extern_kernels.mm(buf4, reinterpret_tensor(arg6_1, (10240, 5120), (1, 10240), 0), out=buf5)
            del arg6_1
            del buf4
            buf7 = empty_strided_cuda((s18, 5120), (5120, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [float_3, add_2, rms_norm_default_2], Original ATen: [aten._to_copy, aten.add, vllm_ir.rms_norm]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_rms_norm_2.run(buf5, arg7_1, buf7, s18, 5120, stream=stream0)
            del arg7_1
            buf8 = empty_strided_cuda((s18, 14336), (14336, 1), torch.bfloat16)
            ...
            extern_kernels.mm(buf7, reinterpret_tensor(arg8_1, (5120, 14336), (1, 5120), 0), out=buf8)
            del arg8_1
            del buf7
            buf20 = empty_strided_cuda((s18, 6144), (6144, 1), torch.bfloat16)
            buf9 = empty_strided_cuda((s18, 24, 1), (24, 1, 24*s18), torch.float32)
            buf10 = empty_strided_cuda((s18, 4, 1), (4, 1, 4*s18), torch.float32)
            ...
            triton_poi_fused_3_xnumel = 6144*s18
            stream0 = get_raw_stream(0)
            triton_poi_fused_3.run(buf8, buf20, triton_poi_fused_3_xnumel, stream=stream0)
            # Topologically Sorted Source Nodes: [split, view, chunk, rms_norm_default_3, view_3, rms_norm_default_4, reshape_1], Original ATen: [aten.split_with_sizes, aten.view, aten.split, vllm_ir.rms_norm, aten._unsafe_view]
            triton_red_fused_4_xnumel_0 = 24*s18
            triton_red_fused_4_xnumel_1 = 4*s18
            stream0 = get_raw_stream(0)
            triton_red_fused_4.run(buf8, buf9, buf10, triton_red_fused_4_xnumel_0, triton_red_fused_4_xnumel_1, stream=stream0)
            buf15 = empty_strided_cuda((s18, 4, 256), (1024, 256, 1), torch.bfloat16)
            buf13 = reinterpret_tensor(buf15, (s18, 4, 64), (1024, 256, 1), 0)  # alias
            buf14 = reinterpret_tensor(buf15, (s18, 4, 192), (1024, 256, 1), 64)  # alias
            buf18 = empty_strided_cuda((s18, 24, 256), (6144, 256, 1), torch.bfloat16)
            buf16 = reinterpret_tensor(buf18, (s18, 24, 64), (6144, 256, 1), 0)  # alias
            buf17 = reinterpret_tensor(buf18, (s18, 24, 192), (6144, 256, 1), 64)  # alias
            ...
            triton_poi_fused_5_xnumel_0 = 256*s18
            triton_poi_fused_5_xnumel_1 = 768*s18
            triton_poi_fused_5_xnumel_2 = 1536*s18
            triton_poi_fused_5_xnumel_3 = 4608*s18
            stream0 = get_raw_stream(0)
            triton_poi_fused_5.run(buf8, buf10, arg11_1, buf11, buf12, buf9, arg10_1, buf13, buf14, buf16, buf17, triton_poi_fused_5_xnumel_0, triton_poi_fused_5_xnumel_1, triton_poi_fused_5_xnumel_2, triton_poi_fused_5_xnumel_3, stream=stream0)
            del arg10_1
            del arg11_1
            del buf10
            del buf11
            del buf12
            del buf9
            buf19 = empty_strided_cuda((s18, 6144), (6144, 1), torch.bfloat16)
            buf21 = empty_strided_cuda((s18, 5120), (5120, 1), torch.bfloat16)
        return (buf15, reinterpret_tensor(buf8, (s18, 4, 256), (14336, 256, 1), 13312), buf18, reinterpret_tensor(buf19, (s18, 24, 256), (6144, 256, 1), 0), buf20, buf21, buf5, )
...
def get_args():
    ...
    arg5_1 = rand_strided((8192, 5120), (5120, 1), device='cuda:0', dtype=torch.bfloat16)
    arg6_1 = rand_strided((5120, 10240), (10240, 1), device='cuda:0', dtype=torch.bfloat16)
    arg7_1 = rand_strided((5120, ), (1, ), device='cuda:0', dtype=torch.bfloat16)
    arg8_1 = rand_strided((14336, 5120), (5120, 1), device='cuda:0', dtype=torch.bfloat16)
    arg9_1 = 8192
    ...
    arg12_1 = rand_strided((1048576, 64), (64, 1), device='cuda:0', dtype=torch.bfloat16)
    arg13_1 = rand_strided((3, 8192), (8193, 1), device='cuda:0', dtype=torch.int64)
    arg14_1 = 8193
