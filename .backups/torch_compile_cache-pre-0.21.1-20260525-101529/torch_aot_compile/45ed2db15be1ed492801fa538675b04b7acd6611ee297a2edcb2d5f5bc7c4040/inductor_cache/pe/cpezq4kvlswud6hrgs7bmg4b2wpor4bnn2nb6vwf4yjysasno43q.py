...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/45ed2db15be1ed492801fa538675b04b7acd6611ee297a2edcb2d5f5bc7c4040/inductor_cache/ys/cyssqqhuh5didtc3uvmmumw2uynu4inqzgkvyhhva4wstfcpz7zm.py
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/45ed2db15be1ed492801fa538675b04b7acd6611ee297a2edcb2d5f5bc7c4040/inductor_cache/3j/c3jtsigk5rc27rwe7ti2zpg2kvwjuxzerualfzdrdy4x3dr7angj.py
...
#   %arg6_1 : Tensor "bf16[s18, 3072][3072, 1]cuda:0" = PlaceHolder[target=arg6_1]
#   %buf2 : Tensor "f32[s18, 1][1, s18]cuda:0" = PlaceHolder[target=buf2]
#   %arg5_1 : Tensor "bf16[3072][1]cuda:0" = PlaceHolder[target=arg5_1]
#   %add_22 : Tensor "bf16[s18, 3072][3072, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm, %arg6_1), kwargs = {})
#   %convert_element_type_2 : Tensor "f32[3072][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg5_1, torch.float32), kwargs = {})
#   %add_21 : Tensor "f32[3072][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_2, 1.0), kwargs = {})
#   %convert_element_type_default_2 : Tensor "f32[s18, 3072][3072, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_22, torch.float32), kwargs = {})
...
#   %mul_tensor_3 : Tensor "f32[s18, 3072][3072, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_tensor_2, %add_21), kwargs = {})
...
#   %moe_forward_shared : [num_users=2] = call_function[target=torch.ops.vllm.moe_forward_shared.default](args = (%convert_element_type_default_3, %convert_element_type_default_3, %convert_element_type_default_3, None, %arg7_1), kwargs = {})
#   return %buf2,%buf3,%buf4,%buf5
triton_red_fused__to_copy_add_moe_forward_shared_rms_norm_1 = async_compile.triton('triton_red_fused__to_copy_add_moe_forward_shared_rms_norm_1', '''
import triton
import triton.language as tl
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/45ed2db15be1ed492801fa538675b04b7acd6611ee297a2edcb2d5f5bc7c4040/inductor_cache/db/cdbcpfkjzxtvhikclxmz7aqtf6cwd7mxk4rum4avuh2ffsqpo3tu.py
...
#   %add_22 : Tensor "bf16[s18, 3072][3072, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm, %arg6_1), kwargs = {})
#   %add_38 : Tensor "bf16[s18, 3072][3072, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%getitem, %getitem_1), kwargs = {})
#   %add_49 : Tensor "bf16[s18, 3072][3072, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_38, %add_22), kwargs = {})
#   %convert_element_type_3 : Tensor "f32[3072][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg8_1, torch.float32), kwargs = {})
#   %add_48 : Tensor "f32[3072][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_3, 1.0), kwargs = {})
#   %convert_element_type_default : Tensor "f32[s18, 3072][3072, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_49, torch.float32), kwargs = {})
...
#   %mul_tensor_1 : Tensor "f32[s18, 3072][3072, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_tensor, %add_48), kwargs = {})
...
#   %copy_ : Tensor "bf16[s18, 3072][3072, 1]cuda:0"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg4_1, %mm), kwargs = {})
#   return %buf9,%convert_element_type_default_1,%buf11
...
@triton_heuristics.reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_red_fused__to_copy_add_copy__rms_norm_2', 'mutated_arg_names': ['in_out_ptr0', 'out_ptr1'], 'optimize_mem': True, 'no_x_dim': False, 'atomic_add_found': False, 'num_load': 9, 'num_store': 2, 'num_reduction': 1, 'backend_hash': '228E29CD04A1C0E45A497D2BB702521B2A73AF056F742B69E679ABE0C11C5D1C', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': False, 'are_deterministic_algorithms_enabled': False, 'add_persistent_rblock': True, 'tiling_scores': {'x': 0, 'r0_': 402659328}}
)
@triton.jit
def triton_red_fused__to_copy_add_copy__rms_norm_2(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    r0_numel = 3072
    rnumel = r0_numel
    RBLOCK: tl.constexpr = R0_BLOCK
    xoffset = tl.program_id(0) * XBLOCK
...
buf0 = generate_example_value((8192, 8192), (8192, 1), 'cuda:0', torch.bfloat16, 0, (8192, 8192))
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_mul_sigmoid_view_0.run(arg0_1, arg2_1, buf0, 67108864, stream=stream0)
...
arg5_1 = generate_example_value((3072,), (1,), 'cuda:0', torch.bfloat16, 0, (3072,))
...
with torch.cuda._DeviceGuard(0):
    triton_red_fused__to_copy_add_moe_forward_shared_rms_norm_1.run(buf1, arg6_1, arg5_1, buf3, buf4, buf5, 8192, 3072, stream=stream0)
del arg5_1, buf3, buf4, buf5

stream0 = get_raw_stream(0)
buf10 = generate_example_value((8192, 3072), (3072, 1), 'cuda:0', torch.bfloat16, 0, (8192, 3072))
buf8 = generate_example_value((8192, 3072), (3072, 1), 'cuda:0', torch.bfloat16, 0, (8192, 3072))
...
with torch.cuda._DeviceGuard(0):
    triton_red_fused__to_copy_add_copy__rms_norm_2.run(buf10, buf8, buf1, arg6_1, arg8_1, arg4_1, 8192, 3072, stream=stream0)
del buf1, arg6_1, buf10, buf8, arg8_1, arg4_1
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            buf0 = empty_strided_cuda((s18, 8192), (8192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [view, sigmoid, mul], Original ATen: [aten.view, aten.sigmoid, aten.mul]
            triton_poi_fused_mul_sigmoid_view_0_xnumel = 8192*s18
            stream0 = get_raw_stream(0)
            ...
            extern_kernels.mm(buf0, reinterpret_tensor(arg3_1, (8192, 3072), (1, 8192), 0), out=buf1)
            del arg3_1
            del buf0
            buf3 = empty_strided_cuda((s18, 3072), (3072, 1), torch.bfloat16)
            buf4 = empty_strided_cuda((s18, 3072), (3072, 1), torch.bfloat16)
            buf5 = empty_strided_cuda((s18, 3072), (3072, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [add_1, float_1, add, rms_norm_default, moe_forward_shared], Original ATen: [aten.add, aten._to_copy, vllm_ir.rms_norm, vllm.moe_forward_shared]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_moe_forward_shared_rms_norm_1.run(buf1, arg6_1, arg5_1, buf3, buf4, buf5, s18, 3072, stream=stream0)
            del arg5_1
            # Topologically Sorted Source Nodes: [add_1, float_1, add, rms_norm_default, moe_forward_shared], Original ATen: [aten.add, aten._to_copy, vllm_ir.rms_norm, vllm.moe_forward_shared]
            buf6 = torch.ops.vllm.moe_forward_shared.default(buf3, buf4, buf5, None, arg7_1)
            del arg7_1
            del buf3
            del buf4
            del buf5
            ...
            # Topologically Sorted Source Nodes: [add_1, add_2, add_4, float_2, add_3, rms_norm_default_1], Original ATen: [aten.add, aten._to_copy, vllm_ir.rms_norm, aten.copy_]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_copy__rms_norm_2.run(buf10, buf8, buf1, arg6_1, arg8_1, arg4_1, s18, 3072, stream=stream0)
            del arg4_1
            del arg6_1
            del arg8_1
            del buf1
...
def get_args():
    ...
    arg3_1 = rand_strided((3072, 8192), (8192, 1), device='cuda:0', dtype=torch.bfloat16)
    ...
    import pickle
    global arg7_1
    arg7_1 = pickle.loads(b'\x80\x04\x95R\x00\x00\x00\x00\x00\x00\x00\x8c\x16vllm.utils.torch_utils\x94\x8c\tLayerName\x94\x93\x94)\x81\x94}\x94\x8c\x05value\x94\x8c\x18mtp.layers.0.mlp.experts\x94sb.')
