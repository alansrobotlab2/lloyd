...
def triton_(in_ptr0, out_ptr0, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r0_offset in tl.range(0, r0_numel, R0_BLOCK):
        ...
        rindex = r0_index
        r0_2 = r0_index
        tmp0 = tl.load(in_ptr0 + (16384 + r0_2 + 256*x0 + 17408*x1), r0_mask & xmask, eviction_policy='evict_first', other=0.0).to(tl.float32)
