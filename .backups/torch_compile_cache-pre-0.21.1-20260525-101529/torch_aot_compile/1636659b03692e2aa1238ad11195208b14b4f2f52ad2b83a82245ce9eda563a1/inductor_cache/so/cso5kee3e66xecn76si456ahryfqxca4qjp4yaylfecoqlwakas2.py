...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/1636659b03692e2aa1238ad11195208b14b4f2f52ad2b83a82245ce9eda563a1/inductor_cache/fm/cfmnhuvvgvilzrkp62i3xj5g2u2r7mhbwu7mksbfr5jnhoucydbb.py
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/1636659b03692e2aa1238ad11195208b14b4f2f52ad2b83a82245ce9eda563a1/inductor_cache/hh/chh7jrt6ocqhoyuxgeww4tgzd4f74t5pszdnztihrp3h2pqqxvgp.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_1', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': None, 'atomic_add_found': False, 'num_load': 3, 'num_store': 1, 'num_reduction': 1, 'backend_hash': '228E29CD04A1C0E45A497D2BB702521B2A73AF056F742B69E679ABE0C11C5D1C', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': False, 'are_deterministic_algorithms_enabled': False}
)
@triton.jit
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/1636659b03692e2aa1238ad11195208b14b4f2f52ad2b83a82245ce9eda563a1/inductor_cache/jd/cjdx2ilpuoeg2drma7rgtk3jafimh5dbmnzxvc5kdlprbacgpua6.py
# Topologically Sorted Source Nodes: [reshape, float_1, pow_1, mean, add, rsqrt, mul, float_2, mul_10, reshape_1, float_3, silu, mul_11, to, rearrange, linear], Original ATen: [aten.view, aten._to_copy, aten.pow, aten.mean, aten.add, aten.rsqrt, aten.mul, aten._unsafe_view, aten.silu, aten.t, aten.mm]
# Source node to ATen node mapping:
#   add => add_22
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/1636659b03692e2aa1238ad11195208b14b4f2f52ad2b83a82245ce9eda563a1/inductor_cache/gt/cgtwa3ziecs4bwvzgwqldd2yfupru7iakci7bc7sqtr5e2kl26yt.py
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/1636659b03692e2aa1238ad11195208b14b4f2f52ad2b83a82245ce9eda563a1/inductor_cache/ao/caoh5dlukcpkwde4mso5byucyigadhfmneb27ainhesjfe6c5awe.py
...
#   %full_default : Tensor "i32[128*(((s18 + 127)//128)), 48][48, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.full.default](args = ([%arg12_1, 48], 0), kwargs = {dtype: torch.int32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %scaled_fp4_quant_out : [num_users=0] = call_function[target=torch.ops._C.scaled_fp4_quant.out](args = (%convert_element_type_default_5, %arg13_1, True), kwargs = {output: %empty_1, output_scale: %full_default})
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/1636659b03692e2aa1238ad11195208b14b4f2f52ad2b83a82245ce9eda563a1/inductor_cache/qt/cqthh4xb6tox56bb7ynookx7inncmuwnxxzz4cbkqtavhy54pmdm.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/1636659b03692e2aa1238ad11195208b14b4f2f52ad2b83a82245ce9eda563a1/inductor_cache/yp/cypz6geewztwqoth44fm3qw4g2cf44nwmngxuennm4lqxasw36i3.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/1636659b03692e2aa1238ad11195208b14b4f2f52ad2b83a82245ce9eda563a1/inductor_cache/2o/c2oetd3gjvsvx2ipnwwlo7b2kl5ua6tlnxuyv56lo6ajt3sfe372.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'SequentialComboKernelGrid', 'combo_grid_meta': {'num_kernels': 4, 'min_blocks': None, 'default_config': None, 'no_x_dim_0': False, 'xnumel_0': None, 'no_x_dim_1': False, 'xnumel_1': None, 'no_x_dim_2': False, 'xnumel_2': None, 'no_x_dim_3': False, 'xnumel_3': None}, 'kernel_name': 'triton_poi_fused_7', 'mutated_arg_names': [], 'backend_hash': '228E29CD04A1C0E45A497D2BB702521B2A73AF056F742B69E679ABE0C11C5D1C', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': False, 'are_deterministic_algorithms_enabled': False}
)
@triton.jit
...
with torch.cuda._DeviceGuard(0):
    stream0 = get_raw_stream(0)
stream0 = get_raw_stream(0)
arg20_1 = generate_example_value((3, 8192), (8193, 1), 'cuda:0', torch.int64, 0, (3, 8192))
arg19_1 = generate_example_value((1048576, 64), (64, 1), 'cuda:0', torch.bfloat16, 0, (1048576, 64))
...
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_0.run(arg20_1, arg19_1, buf16, buf26, buf27, 8193, 393216, 262144, stream=stream0)
del arg20_1, arg19_1, buf16
...
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_7.run(buf23, buf25, arg17_1, buf26, buf27, buf31, arg18_1, buf28, buf29, buf32, buf33, 16777216, 50331648, 1048576, 3145728, stream=stream0)
del buf26, buf27, buf23, buf25, buf31, arg17_1, arg18_1, buf28, buf29, buf32, buf33
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_0.run(arg20_1, arg19_1, buf16, buf26, buf27, s7, triton_poi_fused_0_xnumel_0, triton_poi_fused_0_xnumel_1, stream=stream0)
            # Topologically Sorted Source Nodes: [float_5, add_4, rms_norm_default_1, zeros, scaled_fp4_quant_out], Original ATen: [aten._to_copy, aten.add, vllm_ir.rms_norm, aten.zeros, _C.scaled_fp4_quant]
            ...
            # Topologically Sorted Source Nodes: [float_5, add_4, rms_norm_default_1, zeros, scaled_fp4_quant_out], Original ATen: [aten._to_copy, aten.add, vllm_ir.rms_norm, aten.zeros, _C.scaled_fp4_quant]
            torch.ops._C.scaled_fp4_quant.out(buf15, arg13_1, True, output=buf14, output_scale=buf16)
            del arg13_1
            del buf15
            ...
            buf22 = torch.ops.vllm.flashinfer_mm_fp4.default(buf14, reinterpret_tensor(arg15_1, (1536, 17408), (1, 1536), 0), aten.view.dtype(buf21, torch.uint8), aten.view.dtype(reinterpret_tensor(arg14_1, (192, 17408), (1, 192), 0), torch.uint8), arg16_1, torch.bfloat16, False, 'cutlass')
            del arg14_1
            del arg15_1
            del arg16_1
            del buf14
            ...
            # Topologically Sorted Source Nodes: [split, view_6, chunk, float_6, add_6, rms_norm_default_2, getitem_17, chunk_2, mul_12, mul_13, sub, mul_14, mul_15, add_8, cat, getitem_18, cat_1, view_9, float_7, add_7, rms_norm_default_3, getitem_21, chunk_3, mul_16, mul_17, sub_1, mul_18, mul_19, add_9, cat_2, getitem_22, cat_3], Original ATen: [aten.split_with_sizes, aten.view, aten.split, aten._to_copy, aten.add, vllm_ir.rms_norm, aten.slice, aten.unsqueeze, aten.mul, aten.sub, aten.cat]
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused_7.run(buf23, buf25, arg17_1, buf26, buf27, buf31, arg18_1, buf28, buf29, buf32, buf33, triton_poi_fused_7_xnumel_0, triton_poi_fused_7_xnumel_1, triton_poi_fused_7_xnumel_2, triton_poi_fused_7_xnumel_3, stream=stream0)
            del arg17_1
            del arg18_1
            del buf25
            del buf26
        ...
        return (buf34, reinterpret_tensor(buf23, (s18, 2, 256), (17408, 256, 1), 16896), buf30, reinterpret_tensor(buf35, (s18, 32, 256), (8192, 256, 1), 0), buf24, buf11, buf12, )
...
def get_args():
    ...
    import pickle
    global arg10_1
    arg10_1 = pickle.loads(b'\x80\x04\x95c\x00\x00\x00\x00\x00\x00\x00\x8c\x16vllm.utils.torch_utils\x94\x8c\tLayerName\x94\x93\x94)\x81\x94}\x94\x8c\x05value\x94\x8c)language_model.model.layers.6.mlp.experts\x94sb.')
    arg11_1 = rand_strided((3072, ), (1, ), device='cuda:0', dtype=torch.bfloat16)
    arg12_1 = 8192
    arg13_1 = rand_strided((), (), device='cuda:0', dtype=torch.float32)
    arg14_1 = rand_strided((17408, 192), (192, 1), device='cuda:0', dtype=torch.float8_e4m3fn)
    arg15_1 = rand_strided((17408, 1536), (1536, 1), device='cuda:0', dtype=torch.uint8)
    ...
    arg19_1 = rand_strided((1048576, 64), (64, 1), device='cuda:0', dtype=torch.bfloat16)
    arg20_1 = rand_strided((3, 8192), (8193, 1), device='cuda:0', dtype=torch.int64)
    arg21_1 = 8193
