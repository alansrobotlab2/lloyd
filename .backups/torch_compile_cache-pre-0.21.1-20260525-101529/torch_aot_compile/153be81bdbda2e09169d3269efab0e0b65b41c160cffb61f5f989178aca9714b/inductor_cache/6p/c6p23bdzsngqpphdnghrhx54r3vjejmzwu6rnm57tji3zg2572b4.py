...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/153be81bdbda2e09169d3269efab0e0b65b41c160cffb61f5f989178aca9714b/inductor_cache/uy/cuyndbyxlcj6vko32uzt3buvfk6qcylv5yefrpw3pu2ep3l2tjai.py
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/153be81bdbda2e09169d3269efab0e0b65b41c160cffb61f5f989178aca9714b/inductor_cache/r4/cr46b6ry43poqe2aeruvi37snmhdfelpwrmqufjbojcztm3dawzr.py
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/153be81bdbda2e09169d3269efab0e0b65b41c160cffb61f5f989178aca9714b/inductor_cache/5q/c5q4xamzhgg3hggnx7v42b7ylyi6zt5gp3dbf3yjvkdwih2ykusj.py
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/153be81bdbda2e09169d3269efab0e0b65b41c160cffb61f5f989178aca9714b/inductor_cache/fk/cfkqi4x7lsbwshubbvn3dpmf4mtslwl7q7ozq3c6j7apkjrixhuh.py
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/153be81bdbda2e09169d3269efab0e0b65b41c160cffb61f5f989178aca9714b/inductor_cache/zw/czwar5aggrjyuk4exursig6i7fh42pj42cjsy4acpmbzkss2w7gd.py
...
#   %marlin_gemm_5 : Tensor "bf16[s72, 6144][6144, 1]cuda:0"[num_users=1] = call_function[target=torch.ops._C.marlin_gemm.default](args = (%mul_tensor_3, None, %arg30_1, None, %arg31_1, None, %arg32_1, None, None, None, %arg33_1, 562949953487106, %arg1_1, 6144, 2560, True, False, True, False), kwargs = {})
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/153be81bdbda2e09169d3269efab0e0b65b41c160cffb61f5f989178aca9714b/inductor_cache/ax/caxomegxjzjgg5yxbdkuslv7qy6elstftf4druu6jjkq3hqidcj3.py
...
#   %arg34_1 : Tensor "bf16[512][1]cuda:0" = PlaceHolder[target=arg34_1]
#   %arg35_1 : Tensor "i64[s72][1]cuda:0" = PlaceHolder[target=arg35_1]
#   %arg36_1 : Tensor "bf16[131072, 512][512, 1]cuda:0" = PlaceHolder[target=arg36_1]
#   %cat : Tensor "bf16[s72, 8, 512][4096, 512, 1]cuda:0" = PlaceHolder[target=cat]
...
#   %index : Tensor "bf16[s72, 512][512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%arg36_1, [%arg35_1]), kwargs = {})
#   %split : [num_users=2] = call_function[target=torch.ops.aten.split.Tensor](args = (%index, 256, -1), kwargs = {})
#   %view_13 : Tensor "bf16[s72, 8, 512][6144, 512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%getitem, [%arg1_1, 8, 512]), kwargs = {})
#   %convert_element_type_default : Tensor "f32[s72, 8, 512][4096, 512, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_13, torch.float32), kwargs = {})
#   %pow_tensor_scalar : Tensor "f32[s72, 8, 512][4096, 512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%convert_element_type_default, 2), kwargs = {})
...
#   %mul_tensor : Tensor "f32[s72, 8, 512][4096, 512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_default, %rsqrt_default), kwargs = {})
#   %convert_element_type_default_1 : Tensor "bf16[s72, 8, 512][4096, 512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_tensor, torch.bfloat16), kwargs = {})
#   %mul_tensor_1 : Tensor "bf16[s72, 8, 512][4096, 512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_default_1, %arg34_1), kwargs = {})
#   %split_1 : [num_users=2] = call_function[target=torch.ops.aten.split.Tensor](args = (%mul_tensor_1, 256, -1), kwargs = {})
#   %unsqueeze : Tensor "bf16[s72, 1, 256][512, 256, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%getitem_3, -2), kwargs = {})
#   %mul_156 : Tensor "bf16[s72, 8, 256][2048, 256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%getitem_5, %unsqueeze), kwargs = {})
#   %unsqueeze_1 : Tensor "bf16[s72, 1, 256][512, 256, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%getitem_4, -2), kwargs = {})
#   %mul_159 : Tensor "bf16[s72, 8, 256][2048, 256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%getitem_6, %unsqueeze_1), kwargs = {})
#   %sub_52 : Tensor "bf16[s72, 8, 256][2048, 256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_156, %mul_159), kwargs = {})
#   %mul_164 : Tensor "bf16[s72, 8, 256][2048, 256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%getitem_6, %unsqueeze), kwargs = {})
#   %mul_167 : Tensor "bf16[s72, 8, 256][2048, 256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%getitem_5, %unsqueeze_1), kwargs = {})
#   %add_184 : Tensor "bf16[s72, 8, 256][2048, 256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_164, %mul_167), kwargs = {})
#   %cat : Tensor "bf16[s72, 8, 512][4096, 512, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%sub_52, %add_184], -1), kwargs = {})
#   %view_16 : Tensor "bf16[s72, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%cat, [%arg1_1, 4096]), kwargs = {})
#   %convert_element_type_4 : Tensor "f32[s72, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_16, torch.float32), kwargs = {})
#   %reciprocal : Tensor "f32[][]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reciprocal.default](args = (%arg37_1,), kwargs = {})
#   %mul_223 : Tensor "f32[s72, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_4, %reciprocal), kwargs = {})
#   %clamp_min : Tensor "f32[s72, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.clamp_min.default](args = (%mul_223, -448.0), kwargs = {})
#   %clamp_max : Tensor "f32[s72, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.clamp_max.default](args = (%clamp_min, 448.0), kwargs = {})
#   %convert_element_type_5 : Tensor "f8e4m3fn[s72, 4096][4096, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%clamp_max, torch.float8_e4m3fn), kwargs = {})
...
def triton_red_fused__to_copy_add_cat_clamp_index_select_mul_reciprocal_rms_norm_split_split_with_sizes_sub_unsqueeze_view_5(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr2, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for r0_offset in tl.range(0, r0_numel, R0_BLOCK):
        ...
        tl.store(out_ptr2 + (r0_2 + 512*x3), tmp85, r0_mask & xmask)
''', device_str='cuda')
...
arg36_1 = generate_example_value((131072, 512), (512, 1), 'cuda:0', torch.bfloat16, 0, (131072, 512))
arg37_1 = generate_example_value((), (), 'cuda:0', torch.float32, 0, ())
buf25 = generate_example_value((8192, 4096), (4096, 1), 'cuda:0', torch.float8_e4m3fn, 0, (8192, 4096))
with torch.cuda._DeviceGuard(0):
    triton_red_fused__to_copy_add_cat_clamp_index_select_mul_reciprocal_rms_norm_split_split_with_sizes_sub_unsqueeze_view_5.run(buf22, arg34_1, arg35_1, arg36_1, arg37_1, buf25, 65536, 512, stream=stream0)
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            buf22 = buf21
            del buf21
            buf25 = empty_strided_cuda((s72, 4096), (4096, 1), torch.float8_e4m3fn)
            # Topologically Sorted Source Nodes: [split, index_select, chunk, unflatten, rms_norm_default_5, chunk_1, unsqueeze, mul_3, unsqueeze_1, mul_4, sub, mul_5, mul_6, add_3, cat, reshape_12, to_4, reciprocal, mul_11, clamp, to_6], Original ATen: [aten.split_with_sizes, aten.index_select, aten.split, aten.view, vllm_ir.rms_norm, aten.unsqueeze, aten.mul, aten.sub, aten.add, aten.cat, aten._to_copy, aten.reciprocal, aten.clamp]
            ...
            del arg36_1
            del arg37_1
            buf26 = empty_strided_cuda((s72, 4096), (4096, 1), torch.bfloat16)
        return (reinterpret_tensor(buf25, (s72, 8, 512), (4096, 512, 1), 0), reinterpret_tensor(buf22, (s72, 2, 512), (6144, 512, 1), 4096), reinterpret_tensor(buf22, (s72, 2, 512), (6144, 512, 1), 5120), reinterpret_tensor(buf26, (s72, 8, 512), (4096, 512, 1), 0), buf18, )
...
def get_args():
    ...
    arg36_1 = rand_strided((131072, 512), (512, 1), device='cuda:0', dtype=torch.bfloat16)
