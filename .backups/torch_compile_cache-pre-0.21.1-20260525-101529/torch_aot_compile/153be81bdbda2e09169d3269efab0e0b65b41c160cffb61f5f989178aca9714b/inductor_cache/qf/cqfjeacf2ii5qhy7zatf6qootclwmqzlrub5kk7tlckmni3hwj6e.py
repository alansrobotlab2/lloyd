...
#   %marlin_gemm_5 : Tensor "bf16[s72, 3072][3072, 1]cuda:0"[num_users=1] = call_function[target=torch.ops._C.marlin_gemm.default](args = (%mul_tensor_6, None, %arg30_1, None, %arg31_1, None, %arg32_1, None, None, None, %arg33_1, 562949953487106, %arg1_1, 3072, 2560, True, False, True, False), kwargs = {})
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/153be81bdbda2e09169d3269efab0e0b65b41c160cffb61f5f989178aca9714b/inductor_cache/sx/csxhtrrkrswhjmaev5vhyesw22ct63yraow6hpeb3khfed34ewcd.py
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/153be81bdbda2e09169d3269efab0e0b65b41c160cffb61f5f989178aca9714b/inductor_cache/mk/cmkdepljwnwq42pgmtfwfm6fdaqa7xhv7s5kvxdqk3wbxksupldt.py
...
#   %arg35_1 : Tensor "bf16[256][1]cuda:0" = PlaceHolder[target=arg35_1]
#   %arg36_1 : Tensor "i64[s72][1]cuda:0" = PlaceHolder[target=arg36_1]
#   %arg37_1 : Tensor "bf16[131072, 256][256, 1]cuda:0" = PlaceHolder[target=arg37_1]
...
#   %index : Tensor "bf16[s72, 256][256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%arg37_1, [%arg36_1]), kwargs = {})
#   %split : [num_users=2] = call_function[target=torch.ops.aten.split.Tensor](args = (%index, 128, -1), kwargs = {})
#   %view_15 : Tensor "bf16[s72, 2, 256][3072, 256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%getitem_1, [%arg1_1, 2, 256]), kwargs = {})
#   %convert_element_type_default_2 : Tensor "f32[s72, 2, 256][512, 256, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_15, torch.float32), kwargs = {})
#   %pow_tensor_scalar_1 : Tensor "f32[s72, 2, 256][512, 256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%convert_element_type_default_2, 2), kwargs = {})
...
#   %mul_tensor_1 : Tensor "f32[s72, 2, 256][512, 256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_default_2, %rsqrt_default_1), kwargs = {})
#   %convert_element_type_default_3 : Tensor "bf16[s72, 2, 256][512, 256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_tensor_1, torch.bfloat16), kwargs = {})
#   %mul_tensor_2 : Tensor "bf16[s72, 2, 256][512, 256, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_default_3, %arg35_1), kwargs = {})
#   %split_2 : [num_users=2] = call_function[target=torch.ops.aten.split.Tensor](args = (%mul_tensor_2, 128, -1), kwargs = {})
...
#   %mul_205 : Tensor "bf16[s72, 2, 128][256, 128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%getitem_7, %unsqueeze_2), kwargs = {})
...
#   %mul_208 : Tensor "bf16[s72, 2, 128][256, 128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%getitem_8, %unsqueeze_3), kwargs = {})
#   %sub_72 : Tensor "bf16[s72, 2, 128][256, 128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_205, %mul_208), kwargs = {})
#   %mul_213 : Tensor "bf16[s72, 2, 128][256, 128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%getitem_8, %unsqueeze_2), kwargs = {})
#   %mul_216 : Tensor "bf16[s72, 2, 128][256, 128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%getitem_7, %unsqueeze_3), kwargs = {})
#   %add_257 : Tensor "bf16[s72, 2, 128][256, 128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_213, %mul_216), kwargs = {})
...
arg37_1 = generate_example_value((131072, 256), (256, 1), 'cuda:0', torch.bfloat16, 0, (131072, 256))
arg38_1 = generate_example_value((), (), 'cuda:0', torch.float32, 0, ())
buf31 = generate_example_value((8192, 2048), (2048, 1), 'cuda:0', torch.float8_e4m3fn, 0, (8192, 2048))
buf24 = generate_example_value((8192, 2, 1), (2, 1, 16384), 'cuda:0', torch.float32, 0, (8192, 2, 1))
buf29 = generate_example_value((8192, 2, 256), (512, 256, 1), 'cuda:0', torch.bfloat16, 0, (8192, 2, 256))
with torch.cuda._DeviceGuard(0):
...
stream0 = get_raw_stream(0)
arg35_1 = generate_example_value((256,), (1,), 'cuda:0', torch.bfloat16, 0, (256,))
buf25 = generate_example_value((8192, 2, 128), (512, 256, 1), 'cuda:0', torch.bfloat16, 0, (8192, 2, 128))
buf26 = generate_example_value((8192, 2, 128), (512, 256, 1), 'cuda:0', torch.bfloat16, 0, (8192, 2, 128))
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_add_index_select_mul_rms_norm_split_split_with_sizes_sub_unsqueeze_view_6.run(buf22, buf24, arg35_1, arg36_1, arg37_1, buf25, buf26, 2097152, stream=stream0)
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            buf22 = buf21
            del buf21
            buf31 = empty_strided_cuda((s72, 2048), (2048, 1), torch.float8_e4m3fn)
            buf24 = empty_strided_cuda((s72, 2, 1), (2, 1, 2*s72), torch.float32)
            buf29 = empty_strided_cuda((s72, 2, 256), (512, 256, 1), torch.bfloat16)
            ...
            del arg34_1
            del arg38_1
            buf27 = empty_strided_cuda((s72, 2, 256), (512, 256, 1), torch.bfloat16)
            buf25 = reinterpret_tensor(buf27, (s72, 2, 128), (512, 256, 1), 0)  # alias
            buf26 = reinterpret_tensor(buf27, (s72, 2, 128), (512, 256, 1), 128)  # alias
            # Topologically Sorted Source Nodes: [split, index_select, chunk, unflatten_1, rms_norm_default_6, chunk_2, unsqueeze_2, mul_7, unsqueeze_3, mul_8, sub_1, mul_9, mul_10, add_4], Original ATen: [aten.split_with_sizes, aten.index_select, aten.split, aten.view, vllm_ir.rms_norm, aten.unsqueeze, aten.mul, aten.sub, aten.add]
            triton_poi_fused_add_index_select_mul_rms_norm_split_split_with_sizes_sub_unsqueeze_view_6_xnumel = 256*s72
            stream0 = get_raw_stream(0)
            ...
            del buf22
            del buf24
            buf32 = empty_strided_cuda((s72, 2048), (2048, 1), torch.bfloat16)
        return (buf27, buf29, reinterpret_tensor(buf31, (s72, 8, 256), (2048, 256, 1), 0), reinterpret_tensor(buf32, (s72, 8, 256), (2048, 256, 1), 0), buf18, )
...
def get_args():
    ...
    arg37_1 = rand_strided((131072, 256), (256, 1), device='cuda:0', dtype=torch.bfloat16)
