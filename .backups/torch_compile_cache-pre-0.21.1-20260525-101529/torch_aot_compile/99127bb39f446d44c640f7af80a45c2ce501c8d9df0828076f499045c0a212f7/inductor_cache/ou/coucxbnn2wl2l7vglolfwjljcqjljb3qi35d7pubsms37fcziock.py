...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/99127bb39f446d44c640f7af80a45c2ce501c8d9df0828076f499045c0a212f7/inductor_cache/fp/cfppfe325g6ir54vgmsbghfgxbil4hmbyeeutyjlvy67wf5ghcgs.py
...
#   %arg3_1 : Tensor "i32[s13][1]cuda:0" = PlaceHolder[target=arg3_1]
#   %arg1_1 : Tensor "i32[1][1]cuda:0" = PlaceHolder[target=arg1_1]
#   %arg5_1 : Tensor "i32[1][1]cuda:0" = PlaceHolder[target=arg5_1]
...
#   %index_2 : Tensor "i32[1][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%arg4_1, [%clamp_min]), kwargs = {})
...
#   %index_1 : Tensor "i32[1][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%arg3_1, [%clamp_min]), kwargs = {})
#   %index : Tensor "i32[1][1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.index.Tensor](args = (%arg1_1, [%clamp_min]), kwargs = {})
#   %add : Tensor "i32[1][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%index_1, %index), kwargs = {})
#   %where : Tensor "i32[1][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%bitwise_and, %add, %arg5_1), kwargs = {})
#   %where_1 : Tensor "i32[1][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%bitwise_and, %index, %arg6_1), kwargs = {})
#   %copy__1 : Tensor "i32[1][1]cuda:0"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg6_1, %where_1), kwargs = {})
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/99127bb39f446d44c640f7af80a45c2ce501c8d9df0828076f499045c0a212f7/inductor_cache/gk/cgk5qfgq3j7q35qlvt2j4vgdhcohmkmqpx3mu6lg6ymrikjcksfd.py
...
#   %add : Tensor "i32[1][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%index_1, %index), kwargs = {})
#   %where : Tensor "i32[1][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%bitwise_and, %add, %arg5_1), kwargs = {})
#   %slice_tensor : Tensor "i32[1][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%arg3_1, 0, 0, 1), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        assert_size_stride(arg3_1, (s13, ), (1, ))
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            triton_poi_fused_add_bitwise_and_clamp_copy__ge_gt_index_where_0.run(arg0_1, arg4_1, arg3_1, arg1_1, arg5_1, arg6_1, buf2, arg6_1, s13, 1, stream=stream0)
            del arg0_1
            del arg1_1
            del arg4_1
            del arg5_1
            ...
            # Topologically Sorted Source Nodes: [ge, gather_indices, prev_drafts, gt, participating, prev_computed, valid_counts, corrected, where], Original ATen: [aten.ge, aten.clamp, aten.index, aten.gt, aten.bitwise_and, aten.add, aten.where]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_bitwise_and_clamp_ge_gt_index_where_1.run(buf2, arg3_1, 1, stream=stream0)
            del arg3_1
            del buf2
        return ()
...
def get_args():
    ...
    arg1_1 = rand_strided((1, ), (1, ), device='cuda:0', dtype=torch.int32)
    arg2_1 = 8
    arg3_1 = rand_strided((8, ), (1, ), device='cuda:0', dtype=torch.int32)
