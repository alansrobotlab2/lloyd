...
def get_args():
    ...
    arg_3 = rand_strided((8192, 5120), (10240, 1), device='cuda:0', dtype=torch.bfloat16)
    return arg_0, arg_1, arg_2, arg_3, 8192, 5120,
