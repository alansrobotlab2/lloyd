...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/eb69c7e3dde111637012c090f4584992d427f3453c30a4d7ba56169018f55edb/inductor_cache/sy/csya56nsjiwextf2ojp2wuat7wv6mzlkl7ynysaikyqjcd7obxdc.py
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/eb69c7e3dde111637012c090f4584992d427f3453c30a4d7ba56169018f55edb/inductor_cache/oy/coykphlilwvmfilbfc7drl72f3hjhs4oobfl6spnbgpviwmvxvsa.py
...
#   %scaled_fp4_quant_out_2 : [num_users=0] = call_function[target=torch.ops._C.scaled_fp4_quant.out](args = (%convert_element_type_default_3, %arg12_1, True), kwargs = {output: %empty_1, output_scale: %full_default_1})
#   return %buf10,%buf12
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/eb69c7e3dde111637012c090f4584992d427f3453c30a4d7ba56169018f55edb/inductor_cache/3n/c3njs4pgx7ezj55wvgywqtwfhw7vnggykac5pessnaaeolilyvui.py
...
#   %add_103 : Tensor "bf16[s18, 5120][5120, 1]cuda:0" = PlaceHolder[target=add_103]
#   %buf32 : Tensor "f32[s18, 1][1, s18]cuda:0" = PlaceHolder[target=buf32]
#   %arg20_1 : Tensor "bf16[5120][1]cuda:0" = PlaceHolder[target=arg20_1]
#   %add_40 : Tensor "bf16[s18, 5120][5120, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%flashinfer_mm_fp4, %arg11_1), kwargs = {})
#   %add_103 : Tensor "bf16[s18, 5120][5120, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%flashinfer_mm_fp4_2, %add_40), kwargs = {})
...
#   return %add_103,%buf53,%buf32,%convert_element_type_default_1
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/eb69c7e3dde111637012c090f4584992d427f3453c30a4d7ba56169018f55edb/inductor_cache/7a/c7afhcj74tpu3n26q6lb2samwt6iud4bg6akb2b2rym4hsuv42cd.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'SequentialComboKernelGrid', 'combo_grid_meta': {'num_kernels': 3, 'min_blocks': None, 'default_config': None, 'no_x_dim_0': False, 'xnumel_0': None, 'no_x_dim_1': False, 'xnumel_1': None, 'no_x_dim_2': False, 'xnumel_2': None}, 'kernel_name': 'triton_poi_fused_3', 'mutated_arg_names': [], 'backend_hash': '228E29CD04A1C0E45A497D2BB702521B2A73AF056F742B69E679ABE0C11C5D1C', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': False, 'are_deterministic_algorithms_enabled': False}
)
@triton.jit
def triton_poi_fused_3(out_ptr0, out_ptr1, out_ptr2, xnumel_0, xnumel_1, xnumel_2, XBLOCK : tl.constexpr):
    pid = tl.program_id(0)
    num_xblocks_0 = tl.cdiv(xnumel_0, XBLOCK)
    num_xblocks_1 = num_xblocks_0 + tl.cdiv(xnumel_1, XBLOCK)
    num_xblocks_2 = num_xblocks_1 + tl.cdiv(xnumel_2, XBLOCK)
...
buf33 = generate_example_value((8192, 5120), (5120, 1), 'cuda:0', torch.bfloat16, 0, (8192, 5120))
with torch.cuda._DeviceGuard(0):
    triton_red_fused__to_copy_add_copy__rms_norm_2.run(buf31, buf9, arg11_1, arg20_1, arg9_1, buf33, 8192, 5120, stream=stream0)
del buf9, arg11_1, buf31, arg20_1, arg9_1, buf33

stream0 = get_raw_stream(0)
buf35 = generate_example_value((8192, 80), (80, 1), 'cuda:0', torch.int32, 0, (8192, 80))
buf40 = generate_example_value((8192, 80), (80, 1), 'cuda:0', torch.int32, 0, (8192, 80))
buf52 = generate_example_value((8192, 48, 128), (6144, 128, 1), 'cuda:0', torch.bfloat16, 0, (8192, 48, 128))
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_3.run(buf35, buf40, buf52, 655360, 655360, 50331648, stream=stream0)
del buf35, buf40, buf52
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            del arg16_1
            del buf20
            buf26 = empty_strided_cuda((s18, 5120), (5120, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [flashinfer_mm_fp4_default_2], Original ATen: [aten.view]
            buf27 = torch.ops.aten.view.dtype(buf22, torch.float8_e4m3fn)
            buf28 = buf27
            ...
            buf29 = torch.ops.vllm.flashinfer_mm_fp4.default(buf21, reinterpret_tensor(arg18_1, (8704, 5120), (1, 8704), 0), aten.view.dtype(buf28, torch.uint8), aten.view.dtype(reinterpret_tensor(arg17_1, (1088, 5120), (1, 1088), 0), torch.uint8), arg19_1, torch.bfloat16, False, 'cutlass')
            del arg17_1
            del arg18_1
            del arg19_1
            del buf21
            ...
            buf33 = empty_strided_cuda((s18, 5120), (5120, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [add_1, add_3, float_2, add_2, rms_norm_default_1], Original ATen: [aten.add, aten._to_copy, vllm_ir.rms_norm, aten.copy_]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_copy__rms_norm_2.run(buf31, buf9, arg11_1, arg20_1, arg9_1, buf33, s18, 5120, stream=stream0)
            del arg11_1
            del arg20_1
            del arg9_1
            del buf9
            buf34 = empty_strided_cuda((s18, 2560), (2560, 1), torch.uint8)
            buf35 = empty_strided_cuda((128*((127 + s18) // 128), 80), (80, 1), torch.int32)
            buf40 = empty_strided_cuda((128*((127 + s18) // 128), 80), (80, 1), torch.int32)
            buf52 = empty_strided_cuda((s18, 48, 128), (6144, 128, 1), torch.bfloat16)
            ...
            triton_poi_fused_3_xnumel_0 = 10240*((127 + s18) // 128)
            triton_poi_fused_3_xnumel_1 = 10240*((127 + s18) // 128)
            triton_poi_fused_3_xnumel_2 = 6144*s18
            stream0 = get_raw_stream(0)
            triton_poi_fused_3.run(buf35, buf40, buf52, triton_poi_fused_3_xnumel_0, triton_poi_fused_3_xnumel_1, triton_poi_fused_3_xnumel_2, stream=stream0)
            # Topologically Sorted Source Nodes: [zeros_3, scaled_fp4_quant_out_3], Original ATen: [aten.zeros, _C.scaled_fp4_quant]
            torch.ops._C.scaled_fp4_quant.out(buf33, arg21_1, True, output=buf34, output_scale=buf35)
            del arg21_1
            buf39 = empty_strided_cuda((s18, 2560), (2560, 1), torch.uint8)
            # Topologically Sorted Source Nodes: [zeros_4, scaled_fp4_quant_out_4], Original ATen: [aten.zeros, _C.scaled_fp4_quant]
            torch.ops._C.scaled_fp4_quant.out(buf33, arg25_1, True, output=buf39, output_scale=buf40)
            del arg25_1
            del buf33
            # Topologically Sorted Source Nodes: [flashinfer_mm_fp4_default_3], Original ATen: [aten.view]
            buf44 = torch.ops.aten.view.dtype(buf35, torch.float8_e4m3fn)
            buf45 = buf44
            # Topologically Sorted Source Nodes: [t_6, flashinfer_mm_fp4_default_3, view_15, t_7], Original ATen: [aten.t, aten.view, vllm.flashinfer_mm_fp4]
            buf46 = torch.ops.vllm.flashinfer_mm_fp4.default(buf34, reinterpret_tensor(arg23_1, (2560, 16384), (1, 2560), 0), aten.view.dtype(buf45, torch.uint8), aten.view.dtype(reinterpret_tensor(arg22_1, (320, 16384), (1, 320), 0), torch.uint8), arg24_1, torch.bfloat16, False, 'cutlass')
            del arg22_1
            del arg23_1
            del arg24_1
            del buf34
            ...
            buf48 = torch.ops.aten.view.dtype(buf40, torch.float8_e4m3fn)
            buf49 = buf48
            # Topologically Sorted Source Nodes: [t_8, flashinfer_mm_fp4_default_4, view_19, t_9], Original ATen: [aten.t, aten.view, vllm.flashinfer_mm_fp4]
            buf50 = torch.ops.vllm.flashinfer_mm_fp4.default(buf39, reinterpret_tensor(arg27_1, (2560, 96), (1, 2560), 0), aten.view.dtype(buf49, torch.uint8), aten.view.dtype(reinterpret_tensor(arg26_1, (320, 128), (1, 320), 0), torch.uint8), arg28_1, torch.bfloat16, False, 'cutlass')
            del arg26_1
            del arg27_1
            del arg28_1
            del buf39
            ...
            buf51 = buf50
            del buf50
        return (reinterpret_tensor(buf47, (s18, 10240), (16384, 1), 0), reinterpret_tensor(buf51, (s18, 48), (96, 1), 0), reinterpret_tensor(buf51, (s18, 48), (96, 1), 48), buf52, reinterpret_tensor(buf47, (s18, 48, 128), (16384, 128, 1), 10240), s18, buf26, buf31, )
...
def get_args():
    ...
    arg22_1 = rand_strided((16384, 320), (320, 1), device='cuda:0', dtype=torch.float8_e4m3fn)
    arg23_1 = rand_strided((16384, 2560), (2560, 1), device='cuda:0', dtype=torch.uint8)
    arg24_1 = rand_strided((), (), device='cuda:0', dtype=torch.float32)
    arg25_1 = rand_strided((), (), device='cuda:0', dtype=torch.float32)
    arg26_1 = rand_strided((128, 320), (320, 1), device='cuda:0', dtype=torch.float8_e4m3fn)
    arg27_1 = rand_strided((96, 2560), (2560, 1), device='cuda:0', dtype=torch.uint8)
