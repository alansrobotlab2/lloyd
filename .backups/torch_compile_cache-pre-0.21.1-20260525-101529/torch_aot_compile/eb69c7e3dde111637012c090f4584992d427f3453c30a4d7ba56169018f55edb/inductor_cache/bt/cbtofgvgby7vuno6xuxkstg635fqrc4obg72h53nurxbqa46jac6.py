...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/eb69c7e3dde111637012c090f4584992d427f3453c30a4d7ba56169018f55edb/inductor_cache/og/cogjan6qk4fjmcoaackquvgippbjyvikqwcwzu77ieqq7ogorr6q.py
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/eb69c7e3dde111637012c090f4584992d427f3453c30a4d7ba56169018f55edb/inductor_cache/nm/cnm2c7a4a27as7li6sna6fhul7cmcc6vnebtsyhua35nv4nih7im.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/eb69c7e3dde111637012c090f4584992d427f3453c30a4d7ba56169018f55edb/inductor_cache/hv/chvxlvntgfbgn3z6ojxr7ev4wssssv5h7muqftxl2o7cropm5e34.py
...
#   reshape_1 => view_1
#   rsqrt => rsqrt
#   scaled_fp4_quant_out => scaled_fp4_quant_out_3
...
#   %scaled_fp4_quant_out_3 : [num_users=0] = call_function[target=torch.ops._C.scaled_fp4_quant.out](args = (%view_3, %arg7_1, True), kwargs = {output: %empty, output_scale: %full_default})
#   return %buf2
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/eb69c7e3dde111637012c090f4584992d427f3453c30a4d7ba56169018f55edb/inductor_cache/f6/cf6d2mabddlfm73oefktuogflrkeppm2t7zhxms777mogbmdfpiq.py
...
#   scaled_fp4_quant_out_1 => scaled_fp4_quant_out_2
...
#   %convert_element_type_default_2 : Tensor "f32[s18, 5120][5120, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_83, torch.float32), kwargs = {})
...
#   %mul_tensor_3 : Tensor "f32[s18, 5120][5120, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_tensor_2, %add_82), kwargs = {})
...
#   %scaled_fp4_quant_out_2 : [num_users=0] = call_function[target=torch.ops._C.scaled_fp4_quant.out](args = (%convert_element_type_default_3, %arg14_1, True), kwargs = {output: %empty_1, output_scale: %full_default_1})
#   return %buf11,%buf13
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/eb69c7e3dde111637012c090f4584992d427f3453c30a4d7ba56169018f55edb/inductor_cache/lt/cltksnbj25h2qdo7qcb62vpznspxhtkso3oiaoth4ug77wzxcn2u.py
# Topologically Sorted Source Nodes: [add_2, add_4, float_5, add_3, rms_norm_default_1], Original ATen: [aten.add, aten._to_copy, vllm_ir.rms_norm, aten.copy_]
# Source node to ATen node mapping:
#   add_2 => add_83
#   add_3 => add_145
#   add_4 => add_146
...
#   %convert_element_type_default : Tensor "f32[s18, 5120][5120, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_146, torch.float32), kwargs = {})
...
#   %mul_tensor_1 : Tensor "f32[s18, 5120][5120, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_tensor, %add_145), kwargs = {})
#   %convert_element_type_default_1 : Tensor "bf16[s18, 5120][5120, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_tensor_1, torch.bfloat16), kwargs = {})
...
#   return %add_146,%buf54,%buf33,%convert_element_type_default_1
triton_red_fused__to_copy_add_copy__rms_norm_4 = async_compile.triton('triton_red_fused__to_copy_add_copy__rms_norm_4', '''
import triton
import triton.language as tl
...
# kernel path: /home/alansrobotlab/.cache/vllm/torch_compile_cache/torch_aot_compile/eb69c7e3dde111637012c090f4584992d427f3453c30a4d7ba56169018f55edb/inductor_cache/go/cgo7xjrpsftrv24m7e5chfgh4tjtm7kiha4ulz2zyzow5xfcmdgy.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'SequentialComboKernelGrid', 'combo_grid_meta': {'num_kernels': 3, 'min_blocks': None, 'default_config': None, 'no_x_dim_0': False, 'xnumel_0': None, 'no_x_dim_1': False, 'xnumel_1': None, 'no_x_dim_2': False, 'xnumel_2': None}, 'kernel_name': 'triton_poi_fused_5', 'mutated_arg_names': [], 'backend_hash': '228E29CD04A1C0E45A497D2BB702521B2A73AF056F742B69E679ABE0C11C5D1C', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': False, 'are_deterministic_algorithms_enabled': False}
)
@triton.jit
def triton_poi_fused_5(out_ptr0, out_ptr1, out_ptr2, xnumel_0, xnumel_1, xnumel_2, XBLOCK : tl.constexpr):
    pid = tl.program_id(0)
    num_xblocks_0 = tl.cdiv(xnumel_0, XBLOCK)
    num_xblocks_1 = num_xblocks_0 + tl.cdiv(xnumel_1, XBLOCK)
    num_xblocks_2 = num_xblocks_1 + tl.cdiv(xnumel_2, XBLOCK)
...
buf34 = generate_example_value((8192, 5120), (5120, 1), 'cuda:0', torch.bfloat16, 0, (8192, 5120))
with torch.cuda._DeviceGuard(0):
    triton_red_fused__to_copy_add_copy__rms_norm_4.run(buf32, buf10, arg13_1, arg22_1, arg11_1, buf34, 8192, 5120, stream=stream0)
del buf10, arg13_1, buf32, arg22_1, arg11_1, buf34

stream0 = get_raw_stream(0)
buf36 = generate_example_value((8192, 80), (80, 1), 'cuda:0', torch.int32, 0, (8192, 80))
buf41 = generate_example_value((8192, 80), (80, 1), 'cuda:0', torch.int32, 0, (8192, 80))
buf53 = generate_example_value((8192, 48, 128), (6144, 128, 1), 'cuda:0', torch.bfloat16, 0, (8192, 48, 128))
with torch.cuda._DeviceGuard(0):
    triton_poi_fused_5.run(buf36, buf41, buf53, 655360, 655360, 50331648, stream=stream0)
del buf36, buf41, buf53
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            buf34 = empty_strided_cuda((s18, 5120), (5120, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [add_2, add_4, float_5, add_3, rms_norm_default_1], Original ATen: [aten.add, aten._to_copy, vllm_ir.rms_norm, aten.copy_]
            stream0 = get_raw_stream(0)
            triton_red_fused__to_copy_add_copy__rms_norm_4.run(buf32, buf10, arg13_1, arg22_1, arg11_1, buf34, s18, 5120, stream=stream0)
            del arg11_1
            del arg13_1
            del arg22_1
            del buf10
            buf35 = empty_strided_cuda((s18, 2560), (2560, 1), torch.uint8)
            buf36 = empty_strided_cuda((128*((127 + s18) // 128), 80), (80, 1), torch.int32)
            buf41 = empty_strided_cuda((128*((127 + s18) // 128), 80), (80, 1), torch.int32)
            buf53 = empty_strided_cuda((s18, 48, 128), (6144, 128, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [zeros_3, scaled_fp4_quant_out_3, zeros_4, scaled_fp4_quant_out_4, zeros_5], Original ATen: [aten.zeros, _C.scaled_fp4_quant]
            triton_poi_fused_5_xnumel_0 = 10240*((127 + s18) // 128)
            triton_poi_fused_5_xnumel_1 = 10240*((127 + s18) // 128)
            triton_poi_fused_5_xnumel_2 = 6144*s18
            stream0 = get_raw_stream(0)
            triton_poi_fused_5.run(buf36, buf41, buf53, triton_poi_fused_5_xnumel_0, triton_poi_fused_5_xnumel_1, triton_poi_fused_5_xnumel_2, stream=stream0)
            # Topologically Sorted Source Nodes: [zeros_3, scaled_fp4_quant_out_3], Original ATen: [aten.zeros, _C.scaled_fp4_quant]
            torch.ops._C.scaled_fp4_quant.out(buf34, arg23_1, True, output=buf35, output_scale=buf36)
            del arg23_1
            buf40 = empty_strided_cuda((s18, 2560), (2560, 1), torch.uint8)
            # Topologically Sorted Source Nodes: [zeros_4, scaled_fp4_quant_out_4], Original ATen: [aten.zeros, _C.scaled_fp4_quant]
            torch.ops._C.scaled_fp4_quant.out(buf34, arg27_1, True, output=buf40, output_scale=buf41)
            del arg27_1
            del buf34
            # Topologically Sorted Source Nodes: [flashinfer_mm_fp4_default_3], Original ATen: [aten.view]
            buf45 = torch.ops.aten.view.dtype(buf36, torch.float8_e4m3fn)
            buf46 = buf45
            ...
            buf47 = torch.ops.vllm.flashinfer_mm_fp4.default(buf35, reinterpret_tensor(arg25_1, (2560, 16384), (1, 2560), 0), aten.view.dtype(buf46, torch.uint8), aten.view.dtype(reinterpret_tensor(arg24_1, (320, 16384), (1, 320), 0), torch.uint8), arg26_1, torch.bfloat16, False, 'cutlass')
            del arg24_1
            del arg25_1
            del arg26_1
            del buf35
            ...
            buf48 = buf47
            del buf47
            # Topologically Sorted Source Nodes: [flashinfer_mm_fp4_default_4], Original ATen: [aten.view]
            buf49 = torch.ops.aten.view.dtype(buf41, torch.float8_e4m3fn)
            buf50 = buf49
            # Topologically Sorted Source Nodes: [t_8, flashinfer_mm_fp4_default_4, view_18, t_9], Original ATen: [aten.t, aten.view, vllm.flashinfer_mm_fp4]
            buf51 = torch.ops.vllm.flashinfer_mm_fp4.default(buf40, reinterpret_tensor(arg29_1, (2560, 96), (1, 2560), 0), aten.view.dtype(buf50, torch.uint8), aten.view.dtype(reinterpret_tensor(arg28_1, (320, 128), (1, 320), 0), torch.uint8), arg30_1, torch.bfloat16, False, 'cutlass')
            del arg28_1
            del arg29_1
            del arg30_1
            del buf40
            ...
            buf52 = buf51
            del buf51
        return (reinterpret_tensor(buf48, (s18, 10240), (16384, 1), 0), reinterpret_tensor(buf52, (s18, 48), (96, 1), 0), reinterpret_tensor(buf52, (s18, 48), (96, 1), 48), buf53, reinterpret_tensor(buf48, (s18, 48, 128), (16384, 128, 1), 10240), s18, buf27, buf32, )
...
def get_args():
    ...
    arg24_1 = rand_strided((16384, 320), (320, 1), device='cuda:0', dtype=torch.float8_e4m3fn)
    arg25_1 = rand_strided((16384, 2560), (2560, 1), device='cuda:0', dtype=torch.uint8)
    arg26_1 = rand_strided((), (), device='cuda:0', dtype=torch.float32)
    arg27_1 = rand_strided((), (), device='cuda:0', dtype=torch.float32)
    arg28_1 = rand_strided((128, 320), (320, 1), device='cuda:0', dtype=torch.float8_e4m3fn)
    arg29_1 = rand_strided((96, 2560), (2560, 1), device='cuda:0', dtype=torch.uint8)
    arg30_1 = rand_strided((), (), device='cuda:0', dtype=torch.float32)
    return [arg0_1, arg1_1, arg2_1, arg3_1, arg4_1, arg5_1, arg6_1, arg7_1, arg8_1, arg9_1, arg10_1, arg11_1, arg12_1, arg13_1, arg14_1, arg15_1, arg16_1, arg17_1, arg18_1, arg19_1, arg20_1, arg21_1, arg22_1, arg23_1, arg24_1, arg25_1, arg26_1, arg27_1, arg28_1, arg29_1, arg30_1]
