...
tags:
  ...
  - vla-data-volume
domain: robotics
researched_at: 2026-06-27T00:00:00Z
...
### VLA Training Data Volume Reference (2026)
...
- **Being-H0.5**: Foundation VLA model designed for robust cross-embodiment generalization; evaluates on RoboCasa benchmark at 53.9% (low-res RGB)
...
- Most teams now fine-tune from pretrained VLAs (OpenVLA, Octo) on 50–50K demos depending on task complexity, rather than pre-training from scratch
